...
# serverscratch/
APPS_DIR = ROOT_DIR / "serverscratch"
...
MIGRATION_MODULES = {"sites": "serverscratch.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "serverscratch.users.context_processors.allauth_settings",
            ],
            "libraries": {
...
ADMINS = [("""Sam Solis""", "sam.solis@codematsing.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "serverscratch.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "serverscratch.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "serverscratch.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "serverscratch.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "serverscratch API",
    "DESCRIPTION": "Documentation of API endpoints of serverscratch",
    "VERSION": "1.0.0",
